...
export default function ProductDetailPage({ params }: ProductDetailPageProps) {
  ...
  return (
    <div className="bg-muted min-h-screen flex flex-col">
        ...
        <div className="bg-card rounded-t-3xl z-10 relative -mt-5 p-6 flex-1 flex flex-col">
          ...
          {/* Footer inside the details panel */}
          <div className="bg-card p-4 -mx-6 -mb-6 mt-6 border-t">
